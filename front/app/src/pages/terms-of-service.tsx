...
const TermsOfService: NextPage = () => {
  return (
    <Layout title='Terms-Of-Service'>
      <section className='flex pt-36'>
        <div className=''>
          <div className='mx-auto flex max-w-sm flex-wrap sm:mt-10 sm:max-w-screen-sm lg:-mt-3'>
            <div className='mb-16 mt-5 w-full rounded-[20px] bg-gray-900 px-4 shadow-md sm:-mt-3'>
              <div className='mx-auto my-6 max-w-[510px] text-center lg:mb-6 lg:mt-5'>
                ...
                <p className='text-body-color mx-10 text-base text-sm text-gray-100'>
